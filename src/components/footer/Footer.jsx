...
const Footer = () => {
  return (
    <footer class="flex bg-dark flex-col items-center bg-neutral-900 text-center text-white">
      <div class=" px-6 pt-6 ">
        <div class="mb-6 flex justify-center">
          ...
          <a
            href="https://www.instagram.com/lapyae_4/"
            type="button"
            class="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
            data-te-ripple-init
            data-te-ripple-color="light"
      ...
      >
        © 2023 Copyright:
        <a class="text-whitehite px-3" href="">
          powered by lapyae
        </a>
      </div>
    </footer>
